...
var g = yn.push;
var bn = ``;
var vn = `Expected usable value, not \``;
var ce = (e) => {
  var n = [], r = e.length, t = 0;
  while (t < r) n.push(e[t]), t++;
  return n;
};
var R = (e) => {
  var n = [], r = e.length, t = 1;
  while (t < r) n.push(e[t]), t++;
  return n;
};
var le = (e) => !e ? false : typeof e != `object` ? false : `byteLength` in e && `byteOffset` in e;
var D = (e) => {
  throw new Error(e);
};
var v = (e) => {
...
var H = (e) => {
  ...
  var t = Object.getPrototypeOf(e), n = t == null || t === Object.prototype;
  n = n || Object.getPrototypeOf(t) == null;
  return !n ? false : Symbol.toStringTag in e ? false : Symbol.iterator in e ? false : true;
};
var pe = (e) => {
  if (!e) return false;
  if (Object.prototype.toString.call(e) + "" != `[object Object]`) return false;
  var t = !!Object.prototype.hasOwnProperty.call(e, `constructor`), n = e.constructor;
  h = n ? h && Object.prototype.hasOwnProperty.call(h, `isPrototypeOf`) : false;
  if (n && !t && !h) return false;
  h = bn, t = false;
  for (n in e) h = n, t = true;
  return !t ? true : !!Object.prototype.hasOwnProperty.call(e, h);
};
var fe = (e, t, n) => {
  if (t == `__proto__`) {
...
var me = (e, t) => t == `__proto__` ? !C.call(e, t) ? void 0 : Object.getOwnPropertyDescriptor(e, t).value : e[t];
var I = (e, t) => {
  (e == null || typeof e != `object` && typeof e != `function`) && (e = {});
  if (t == null) return e;
  for (var i in t) {
    var r = me(e, i), n = me(t, i);
    e !== n && (!!n && (pe(n) || Array.isArray(n)) ? (Array.isArray(n) ? r && Array.isArray(r) || (r = []) : r && pe(r) || (r = {}), fe(e, i, I(r, n))) : typeof n != `undefined` && fe(e, i, n));
  }
  return e;
};
var S = (e) => (!e ? false : typeof e != `object` ? false : `message` in e && `messages` in e) ? e : new q(e);
var P = (e, t) => {
  typeof t == `function` || v(`Cannot \`` + e + `\` without \`parser\``);
};
var F = (e, t) => {
  typeof t == `function` || v(`Cannot \`` + e + `\` without \`compiler\``);
};
var M = (e, t) => {
  !t || D(`Cannot call \`` + e + `\` on a frozen processor.
Create a new processor first, by calling it: use \`processor()\` instead of \`processor\`.`);
};
var ge = (e) => {
  (!H(e) || typeof e.type != `string`) && v(`Expected node, got \`` + e + `\``);
};
var ye = (e, t, n) => {
  n || D(`\`` + e + `\` finished async. Use \`` + t + `\` instead`);
};
var G = (e) => {
  var t = e.parser;
  typeof t == `function` || (t = e.Parser);
  return t;
};
var Y = (e) => {
  var t = e.compiler;
  typeof t == `function` || (t = e.Compiler);
  return t;
};
var B = (e, t, n) => {
  for (var s, a2, i = e.length, r = -1; ; ) {
    if (false) {
      r = -1;
      break;
    }
  ...
  if (r == -1) {
    r = [t], i = n.length, t = 0;
    while (t < i) r.push(n[t]), t++;
    g.call(e, r);
    return;
  }
  if (n.length > 0) {
    i = n[0], s = R(n), a2 = e[r][1], H(a2) && H(i) && (i = I(a2, i)), n = [t, i], i = s.length, t = 0;
    while (t < i) n.push(s[t]), t++;
    ae.call(e, r, 1, n);
  }
};
var be = (e, t, n) => {
  if (n != null) {
    Array.isArray(n) || v(`Expected a list of plugins, not \`` + n + `\``);
    for (var i = n.length, r = -1; ++r < i; ) $2.add(e, t, n[r]);
  }
};
var ve = (e, t, n) => {
  !(`plugins` in n) && !(`settings` in n) && D(`Expected usable value but received an empty preset, which is probably a mistake: presets typically come with \`plugins\` and sometimes with \`settings\`, but this has neither`), be(e, t, n.plugins), e = n.settings, e && (t.settings = I(t.settings, e));
};
var we = () => {
  var t = {}, e = (0, function() {
    for (var r = t.self, e2 = ee(), i = r.attachers, s = i.length, n2 = -1; ++n2 < s; ) e2.use.apply(e2, i[n2]);
    n2 = e2.data, e2.data(I({}, r.namespace));
    return e2;
  });
  t.self = e, e.attachers = [], e.compiler = void 0, e.parser = void 0, e.Compiler = void 0, e.Parser = void 0, e.freezeIndex = -1, e.frozen = void 0, e.namespace = {};
  var n = { fns: [], run: Fe, use: Me };
  e.transformers = n, e.use = Ge, e.parse = Ye, e.run = Be, e.runSync = Ve, e.stringify = We, e.process = Ke, e.processSync = Xe, e.data = Ze, e.freeze = Je;
  return e;
};
var h = (e) => `string` == typeof e ? e : e === void 0 ? `undefined` : e == null ? `null` : String(e) + "";
var c = (e) => e == null ? false : !!e;
var p = (e) => h(String.fromCharCode.call(String, e));
var x = (e) => !Array.isArray(e) ? 0 : e.length;
var z = (e) => {
  if (e == null) return [];
  var t = e.children;
...
var ke = (e) => {
  ...
  while (n < r) {
    t = e.charCodeAt(n);
    if (9 != t && 10 != t && 12 != t && 13 != t && 32 != t) return false;
    n++;
  }
  return true;
};
var xe = (e) => `string` == typeof e ? ke(e) : e == null || typeof e != `object` ? false : l(e) == `text` ? ke(h(e.value)) : false;
var ze = (e, t) => {
  var i = e.length, n = 0, r = 0;
  while (r < i) e.charAt(r) == t && (n = n + 1 | 0), r++;
  return n;
};
var O = (e) => {
  throw new Error(e);
...
var je = (e, t, n) => {
  var s = n.length, i = 0, r = 0;
  while (r <= s) (r == s || n.charAt(r) == `
`) && (r > i && ((e2, t2, n2) => {
    var a2 = n2.length, i2 = -1, s2 = -1, r2 = 0;
    while (r2 < a2) n2.charAt(r2) == `|` && (i2 < 0 ? i2 = r2 : s2 < 0 && (s2 = r2)), r2++;
    if (!(i2 < 0 || s2 < 0)) r2 = n2.slice(0, i2), i2 = n2.slice(i2 + 1 | 0, s2), e2[r2] = i2 + `|` + n2.slice(s2 + 1 | 0), t2[r2.toLowerCase()] = r2, t2[i2.toLowerCase()] = r2;
  })(e, t, n.slice(i, r)), i = r + 1 | 0), r++;
};
var V = (e, t) => {
  (() => {
    !se && (se = true, je(te, ne, `ariaActiveDescendant|aria-activedescendant|
...
xmlBase|xml:base|
xmlLang|xml:lang|
xmlSpace|xml:space|`), je(re, ie, `ariaActiveDescendant|aria-activedescendant|
ariaAtomic|aria-atomic|
ariaAutoComplete|aria-autocomplete|
ariaBusy|aria-busy|
ariaChecked|aria-checked|
...
xmlSpace|xml:space|`));
  ...
  var r = te, n = ne;
  e == `svg` && (r = re, n = ie), e = t.toLowerCase();
  if (Object.prototype.hasOwnProperty.call(n, e)) {
    var i = Object;
    e = n[e], `string` == typeof e || (e = bn), t = r[e], `string` == typeof t || (t = bn);
    return { property: e, packed: t };
  }
  e.length > 4 && e.slice(0, 4) == `data` && ((e2) => {
    if (e2.length < 5) return false;
    if (e2.toLowerCase().slice(0, 4) != `data`) return false;
    var t2, r2 = e2.length, n2 = 4;
    while (n2 < r2) {
      t2 = e2.charCodeAt(n2), t2 = t2 >= 48 && t2 <= 57 || t2 >= 65 && t2 <= 90 || t2 >= 97 && t2 <= 122 || 45 == t2 || 95 == t2 || 46 == t2 || 58 == t2;
      if (!t2) return false;
      n2++;
    }
    return true;
  })(t) ? t.length > 4 && t.charAt(4) == `-` ? (e = ((e2) => {
    var r2, i2 = e2.length, n2 = bn, t2 = 0;
    while (t2 < i2) t2 < i2 - 1 && e2.charAt(t2) == `-` ? (r2 = e2.charCodeAt(t2 + 1), r2 >= 97 && r2 <= 122 ? (n2 = n2 + e2.charAt(t2 + 1).toUpperCase(), t2 = t2 + 2 | 0) : (n2 = n2 + e2.charAt(t2), t2++)) : (n2 = n2 + e2.charAt(t2), t2++);
    return n2;
  })(t.slice(5)), e = e.length > 0 ? `data` + e.charAt(0).toUpperCase() + e.slice(1) : `data`, i = t, t = e, e = i) : (e = t.slice(4), !((e2) => {
    var n2, r2 = e2.length, t2 = 0;
    while (t2 < r2 - 1) {
      if (e2.charAt(t2) == `-` && (n2 = e2.charCodeAt(t2 + 1), n2 >= 97 && n2 <= 122)) return true;
      t2++;
    }
    return false;
  })(e) ? (e = ((e2) => {
    var r2, i2, s = e2.length, t2 = bn, n2 = 0;
    while (n2 < s) r2 = e2.charAt(n2), i2 = e2.charCodeAt(n2), t2 = i2 >= 65 && i2 <= 90 ? t2 + (`-` + r2.toLowerCase()) : t2 + r2, n2++;
    return t2;
  })(e), (0 == e.length || e.charAt(0) != `-`) && (e = `-` + e), e = `data` + e) : e = t) : e = t;
  return { property: t, packed: e + `|` };
};
var qe = (e) => {
  var t = e.packed;
  return `string` == typeof t ? t : bn;
};
var Ee = (e) => {
  var t = qe(e);
  e = 0;
  while (e < t.length) {
    if (t.charAt(e) == `|`) return t.slice(e + 1);
    e++;
  }
  return bn;
};
var b = (e, t) => {
  var n = 0;
  while (n < e.length) {
    if (e.charAt(n) == t) return true;
    n++;
  }
  return false;
};
var Te = (e) => {
  var t, s = [], i = e.length, r = bn, n = 0;
  while (n <= i) t = n < i ? e.charCodeAt(n) : 0, n == i || 9 == t || 10 == t || 12 == t || 13 == t || 32 == t ? r.length > 0 && (s.push(r), r = bn) : r += e.charAt(n), n++;
  return s;
};
var Ne = (e) => {
  var n, t, r, a2 = [], b2 = e.length, i = bn, s = 0;
  while (s <= b2) {
    if (s == b2 || e.charAt(s) == `,`) {
      n = i.length, r = 0;
      while (r < n) {
        t = i.charCodeAt(r);
        if (9 == t || 10 == t || 12 == t || 13 == t || 32 == t) r++;
        else break;
      }
      while (n > r) {
        t = i.charCodeAt(n - 1);
...
var Re = (e, t, n, r) => `string` != typeof r ? r : ((e != `html` ? false : t == `border` || t == `bottomMargin` || t == `cols` || t == `height` || t == `high` || t == `hSpace` || t == `leftMargin` || t == `low` || t == `marginHeight` || t == `marginWidth` || t == `maxLength` || t == `minLength` || t == `optimum` || t == `results` || t == `rightMargin` || t == `rows` || t == `rowSpan` || t == `size` || t == `span` || t == `start` || t == `tabIndex` || t == `topMargin` || t == `vSpace` || t == `width`) || b(n, `n`)) && r.length > 0 && !Number.isNaN(e = Number(r)) ? e : (b(n, `b`) || b(n, `o`)) && (0 == r.length || r.toLowerCase() == t.toLowerCase()) ? true : r;
var Ie = (e, t) => {
  var i = e.length;
  t < 0 && (t = 0), t > i && (t = i);
  var n, s = 0, a2 = 1, r = 0;
  while (r < t) n = e.charCodeAt(r), 13 == n ? (n = r + 1, n < i && 10 == e.charCodeAt(n) && (n = r + 2 | 0), n <= t && (s = n, a2++), r = n) : 10 == n ? (r = r + 1, r <= t && (s = r, a2++)) : r += 1;
  return { line: a2, column: (t - s | 0) + 1 | 0, offset: t };
};
var f = (e) => `string` == typeof e ? e : e == null ? bn : e + "";
var W = (e) => e == null ? 0 : e | 0;
var K = (e) => {
  var t = e.space;
  return `string` == typeof t ? t : `html`;
};
var Se = (e, t, n) => {
  e = W(e);
  var r = W(t);
  return 0 == e || 0 == r ? void 0 : { line: e, column: r, offset: W(n) };
};
var j = (e) => {
  if (e != null) {
    var t = e.startLine, r = e.startCol;
    t = Se(t, r, e.startOffset);
    var n = e.endLine, i = e.endCol;
    n = Se(n, i, e.endOffset);
    return t === void 0 && n === void 0 ? void 0 : { start: t, end: n };
  }
};
var U = (e, t, n) => {
  if (`sourceCodeLocation` in t) {
    var r = t.sourceCodeLocation;
    if (r != null && !!e.file) t = ((e2, t2, n2) => {
      var s = j(n2);
      if (f(t2.type) != `element`) return s;
      var r2 = t2.children;
      if (s != null && !n2.endTag) {
        var i;
        Array.isArray(r2) && r2.length > 0 && (i = r2[r2.length - 1].position, r2 = i == null, r2 || (r2 = i.end, i = r2 == null, i || (s.end = Object.assign({}, r2))));
      }
      if (e2.verbose) {
        i = {}, r2 = n2.attrs;
        var b2, a2 = r2 == null;
        if (!a2 && typeof r2 == `object`) {
          a2 = K(e2);
          for (e2 in r2) b2 = f(V(a2, e2).property), i[b2] = j(r2[e2]);
        }
        e2 = { opening: j(n2.startTag), properties: i };
        r2 = n2.endTag, r2 && (e2.closing = j(r2)), t2.data = { position: e2 };
      }
      return s;
    })(e, n, r), r = t == null, r || (e.location = true, n.position = t);
  }
};
var Oe = (e, t) => {
  var n = [];
  ...
  var i = t.length, r = 0;
  while (r < i) n.push(E.one(e, t[r])), r++;
  return n;
};
var Ue = (e, t) => {
  var n = f(t.nodeName);
  if (n == `#comment`) return n = { type: `comment`, value: f(t.data) }, U(e, t, n), n;
  if (n == `#document` || n == `#document-fragment`) {
    `mode` in t ? (n = f(t.mode), n = n == `quirks` || n == `limited-quirks`) : n = false, n = { type: `root`, children: Oe(e, t.childNodes), data: { quirksMode: n } };
    if (e.file && e.location) t = ((e2) => {
      if (`string` == typeof e2) return e2;
      if (e2 == null) return bn;
      if (typeof e2.toString == `function`) {
        e2 = e2.toString();
        return `string` == typeof e2 ? e2 : e2 + "";
      }
      return e2 + "";
    })(e.file), n.position = { start: Ie(t, 0), end: Ie(t, t.length) };
    return n;
  }
  return n == `#documentType` ? (n = { type: `doctype` }, U(e, t, n), n) : n == `#text` ? (n = { type: `text`, value: f(t.value) }, U(e, t, n), n) : E.element(e, t);
};
var Ae = (e) => e == null ? `1` : typeof e != `number` ? `1` : !e ? `1` : e + "";
var X = (e) => {
  if (e == null || typeof e != `object`) return `1:1`;
  var t = Ae(e.line) + `:`;
  return t + Ae(e.column);
};
var Ce = (e) => e == null || typeof e != `object` ? bn : `position` in e || `type` in e ? Ce(e.position) : `start` in e || `end` in e ? X(e.start) + `-` + X(e.end) : `line` in e || `column` in e ? X(e) : bn;
var Z = (e, t, n) => {
  var s = e.length, i = n.startOffset;
  n = i == null;
  var b2 = !n ? i | 0 : 0;
  i = bn, n = 0;
  while (n < s) if (n + 1 < s && e.charAt(n) == `%` && e.charAt(n + 1) == `x`) {
    var r;
    r = b2 >= 0 && b2 < t.length ? t.charCodeAt(b2) : 0, i += `0x` + ((e2) => {
      if (e2 <= 0) return `0`;
      var t2 = bn;
      while (e2 > 0) t2 = `0123456789ABCDEF`.charAt(e2 % 16) + t2, e2 = e2 / 16 | 0;
      return t2;
    })(r), n = n + 2 | 0;
  } else if (n + 1 < s && e.charAt(n) == `%` && e.charAt(n + 1) == `c`) {
    r = n + 2 | 0;
    var a2, m2, o, u;
    if (r < s && (e.charAt(r) == `+` || e.charAt(r) == `-`)) {
      m2 = e.charAt(r), a2 = n + 3 | 0, r = 0, u = false;
      while (a2 < s) {
        o = e.charCodeAt(a2);
        if (o >= 48 && o <= 57) r = (r * 10 | 0) + (o - 48) | 0, a2++;
        else {
          break;
        }
        u = true;
      }
      u ? (m2 == `-` && (r = 0 - r | 0), n = a2) : (n = n + 2 | 0, r = 0);
    } else {
      n = n + 2 | 0, r = 0;
    }
    r = b2 + r | 0;
    r = r >= 0 && r < t.length ? t.charAt(r) : bn, i += r == `\`` ? `\` \` \`` : r;
  } else {
    i += e.charAt(n), n++;
  }
  return i;
...
var J = (e, t) => {
  if (!(t == null || typeof t != `object`)) for (var n in t) e[n] = t[n];
};
var m = (e, t) => {
  var r, s = e.length, n = bn, i = 0;
  while (i < s) r = e.charAt(i), ((e2, t2) => {
    var r2 = t2.length, n2 = 0;
    while (n2 < r2) {
      if (t2.charAt(n2) == e2) return true;
      n2++;
    }
    return false;
  })(r, t) ? (n = n + `&#x`, n = n + ((e2) => {
    ...
    while (e2 > 0) t2 = `0123456789ABCDEF`.charAt(e2 % 16) + t2, e2 = e2 / 16 | 0;
    return t2;
  })(r.charCodeAt(0)) + `;`) : n += r, i++;
  return n;
};
var Ot = (e, t) => {
  var r = p(0), n = p(9);
  n += p(10), n += p(12), n = n + p(13) + ` `;
  return e ? t ? n + `&/=>` : n + `"&'/=>\`` : t ? r + n + `"&'/<=>` : r + n + `"&'/<=>\``;
};
var Ut = (e, t) => {
  var i = p(0), n = p(9), s = p(10);
  n += s;
  var r = p(12);
  n += r, r = p(13), n = n + r + ` `;
  return e && t ? n + `&>` : i + n + `"&'<=>\``;
...
var w = (e, t, n, r) => {
  t = T(e, t, n, r);
  return t < 0 ? void 0 : z(e)[t];
};
var N = (e) => e == null ? false : l(e) == `comment`;
var a = (e, t) => e == null ? false : l(e) == `element` && y(e) == t;
var k = (e, t, n) => {
  if (e == null) return false;
  if (l(e) != `element`) return false;
  e = y(e), e = e == t || e == n;
  return e;
};
var Le = (e) => {
  if (e == null) return false;
  if (l(e) != `text`) return false;
  var t = e.value;
  `string` == typeof t || (t = bn);
  return 0 == t.length ? false : xe(t.charAt(0));
};
var Q = (e, t, n) => {
  e = y(e);
  return e == `body` ? !N(d(n, t)) : e == `caption` || e == `colgroup` || e == `head` ? ((e2, t2) => {
    e2 = w(t2, e2, 1, true);
    return e2 == null ? true : N(e2) ? false : l(e2) == `text` && Le(e2) ? false : true;
  })(t, n) : e == `dd` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : k(e2, `dt`, `dd`);
  })(t, n) : e == `dt` ? k(d(n, t), `dt`, `dd`) : e == `html` ? !N(d(n, t)) : e == `li` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : a(e2, `li`);
  })(t, n) : e == `optgroup` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : a(e2, `optgroup`);
  })(t, n) : e == `option` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : k(e2, `option`, `optgroup`);
  })(t, n) : e == `p` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 != null ? l(e2) == `element` && (!a(e2, `address`) && !a(e2, `article`) && !a(e2, `aside`) && !a(e2, `blockquote`) && !a(e2, `details`) && !a(e2, `div`) && !a(e2, `dl`) && !a(e2, `fieldset`) && !a(e2, `figcaption`) && !a(e2, `figure`) && !a(e2, `footer`) && !a(e2, `form`) ? !a(e2, `h1`) && !a(e2, `h2`) && !a(e2, `h3`) && !a(e2, `h4`) && !a(e2, `h5`) && !a(e2, `h6`) && !a(e2, `header`) && !a(e2, `hgroup`) && !a(e2, `hr`) && !a(e2, `main`) && !a(e2, `menu`) && !a(e2, `nav`) && !a(e2, `ol`) && !a(e2, `p`) && !a(e2, `pre`) && !a(e2, `section`) && !a(e2, `table`) && !a(e2, `ul`) ? false : true : true) : t2 == null ? true : !((e3) => {
      if (e3 == null) return false;
      if (l(e3) != `element`) return false;
      var t3 = y(e3);
      return t3 == `a` || t3 == `audio` || t3 == `del` || t3 == `ins` || t3 == `map` || t3 == `noscript` || t3 == `video`;
    })(t2);
  })(t, n) : e == `rp` || e == `rt` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : k(e2, `rp`, `rt`);
  })(t, n) : e == `tbody` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : k(e2, `tbody`, `tfoot`);
  })(t, n) : e == `td` || e == `th` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : k(e2, `td`, `th`);
  })(t, n) : e == `tfoot` ? T(n, t, 1, false) < 0 : e == `thead` ? k(d(n, t), `tbody`, `tfoot`) : e == `tr` ? ((e2, t2) => {
    e2 = d(t2, e2);
    return e2 == null ? true : a(e2, `tr`);
  })(t, n) : false;
};
var $t = (t, n, r) => {
  var i = y(t);
  return i == `body` ? ((e) => {
    e = w(e, -1, 1, true);
    var t2;
    return e == null ? true : N(e) ? false : l(e) == `text` && Le(e) ? false : l(e) == `element` && (t2 = y(e), t2 == `meta` || t2 == `link` || t2 == `script` || t2 == `style` || t2 == `template`) ? false : true;
  })(t) : i == `colgroup` ? ((e, t2, n2) => {
    var r2 = w(n2, t2, -1, false), i2 = w(e, -1, 1, true);
    e = n2 == null;
    return !e && r2 != null && a(r2, `colgroup`) && Q(r2, T(n2, t2, -1, false), n2) ? false : a(i2, `col`);
  })(t, n, r) : i == `head` ? ((e) => {
    var t2, n2 = z(e), i2 = x(n2), e = false, s = false, r2 = 0;
    while (r2 < i2) {
      t2 = n2[r2];
      if (l(t2) == `element`) {
        t2 = y(t2);
    ...
    return 0 == i2 ? true : l(n2[0]) == `element`;
  })(t) : i == `html` ? !N(w(t, -1, 1, false)) : i == `tbody` ? ((e, t2, n2) => {
    var r2 = w(n2, t2, -1, false), i2 = w(e, -1, 1, false);
    e = n2 == null;
    return !e && r2 != null && (a(r2, `thead`) || a(r2, `tbody`)) && Q(r2, T(n2, t2, -1, false), n2) ? false : a(i2, `tr`);
  })(t, n, r) : false;
};
var De = (e) => {
  var t = e.schema;
...
var rn = (e, t, n) => {
  var a2 = e.settings, r = De(e), o = a2.allowParseErrors && r == `html`, u = !!a2.allowDangerousCharacters;
  t = V(r, t), r = ((e2) => {
    e2 = qe(e2);
    var t2 = 0;
    while (t2 < e2.length) {
      if (e2.charAt(t2) == `|`) return e2.slice(0, t2);
      t2++;
    }
    return e2;
  })(t);
  var s = Ee(t);
  t = b(s, `b`);
  var i = b(s, `o`), g2 = b(s, `c`);
  i && `string` == typeof n && (n == r || n == bn) && (n = true), t || i ? (t = `string` == typeof n, t = !t || t && (n == r || n == bn)) : t = false, t && (n = n == null ? false : `boolean` == typeof n ? n : `string` == typeof n ? n.length > 0 : typeof n == `number` ? Number.isNaN(n) ? false : !!n : !!n);
  if (n == null) return bn;
  t = `boolean` == typeof n;
  if (t && !n) return bn;
  if (typeof n == `number` && Number.isNaN(n)) return bn;
  var p2 = Ot(o, u);
  s = m(r, p2);
  if (t && n) return s;
  if (Array.isArray(n)) {
    var c2, y2, A2 = g2 ? a2.tightCommaSeparatedLists ? `,` : `, ` : ` `;
    c2 = x(n), t = bn, r = false, i = 0;
    while (i < c2) g2 = n[i], y2 = g2 == null, y2 || (r && (t = t + A2), t = t + h(g2), r = true), i++;
  } else {
    t = h(n);
  }
  if (a2.collapseEmptyAttributes && 0 == t.length) return s;
  n = ((e2) => {
    var t2 = e2.quote;
    return `string` == typeof t2 ? t2 : `"`;
  })(e), a2.preferUnquoted ? (r = m(t, Ut(o, u)), i = r == t) : (r = bn, i = false), i || (!a2.quoteSmart || (e = ((e2) => {
    var t2 = e2.alternative;
    return `string` == typeof t2 ? t2 : `'`;
  })(e), ze(t, n) > ze(t, e) && (n = e)), e = Ct(o, u), n == `'` && (e = At(o, u)), r = n + m(t, e) + n);
  return 0 == r.length ? s : s + `=` + r;
};
var He = (e, t, n) => {
  var i = e.value, r = h(i);
  e = t == null;
  return !e && l(t) == `element` && (e = y(t), e == `script` || e == `style`) ? r : ((e2) => {
    var t2 = e2.characterReferences;
    return t2 == null || typeof t2 != `object` ? false : !!t2.useNamedReferences;
  })(n.settings) ? ((e2) => {
    var n2, i2 = e2.length, t2 = bn, r2 = 0;
    while (r2 < i2) n2 = e2.charAt(r2), n2 == `&` ? t2 = t2 + `&amp;` : n2 == `<` ? t2 = t2 + `&lt;` : t2 += n2, r2++;
    return t2;
  })(r) : m(r, `<&`);
};
var an = (e, t) => {
  var n = h(e.value);
  return t.settings.bogusComments ? `<?` + m(n, `>`) + `>` : `<!--` + ((e2) => {
    var r, i = e2.length, t2 = bn, n2 = 0;
    while (n2 < i) r = e2.slice(n2), 0 == n2 && r.length > 0 && r.charAt(0) == `>` ? (t2 = t2 + m(`>`, `<>`), n2++) : 0 == n2 && r.length >= 2 && r.slice(0, 2) == `->` ? (t2 = t2 + m(`->`, `<>`), n2 = n2 + 2 | 0) : r.length >= 4 && r.slice(0, 4) == `<!--` ? (t2 = t2 + m(`<!--`, `<>`), n2 = n2 + 4 | 0) : r.length >= 4 && r.slice(0, 4) == `--!>` ? (t2 = t2 + m(`--!>`, `<>`), n2 = n2 + 4 | 0) : r.length >= 3 && r.slice(0, 3) == `-->` ? (t2 = t2 + m(`-->`, `<>`), n2 = n2 + 3 | 0) : r == `<!-` ? (t2 = t2 + m(`<!-`, `<>`), n2 = i) : (t2 = t2 + r.charAt(0), n2++);
    return t2;
  })(n) + `-->`;
};
var _ = (e, t, n, r) => {
  (e == null || typeof e != `object` || Array.isArray(e)) && O(`Expected node, not \`` + h(e) + `\``);
  var i = e.type, s = `string` == typeof i;
  s || O(`Expected node, not \`` + h(e) + `\``), s || (i = bn);
  if (i == `text`) return He(e, n, r);
  if (i == `comment`) return an(e, r);
  if (i == `doctype`) return ((e2) => {
    var t2 = e2.settings;
    e2 = t2.upperDoctype ? `DOCTYPE` : `doctype`, t2 = t2.tightDoctype ? bn : ` `;
    return `<!` + e2 + t2 + `html>`;
  })(r);
  if (i == `raw`) return r.settings.allowDangerousHtml ? h(e.value) : He(e, n, r);
  if (i == `root`) {
    i = z(e), s = x(i), n = bn, t = 0;
    while (t < s) n += _(i[t], t, e, r), t++;
    return n;
  }
  if (i == `element`) {
    var a2 = r.settings;
    i = De(r);
    var u, m2, g2, c2, p2, b2, o = y(e), A2 = i != `svg` && a2.omitOptionalTags;
    u = i == `svg` ? !!a2.closeEmptyElements : ((e2, t2) => {
      if (e2 == null || !Array.isArray(e2)) return t2 == `area` || t2 == `base` || t2 == `basefont` || t2 == `bgsound` || t2 == `br` || t2 == `col` || t2 == `command` || t2 == `embed` || t2 == `frame` || t2 == `hr` || t2 == `image` || t2 == `img` || t2 == `input` || t2 == `keygen` || t2 == `link` || t2 == `meta` || t2 == `param` || t2 == `source` || t2 == `track` || t2 == `wbr`;
      var r2 = x(e2), n2 = 0;
      while (n2 < r2) {
        if (h(e2[n2]) == t2) return true;
        n2++;
      }
      return false;
    })(a2.voids, o.toLowerCase()), i == `html` && o == `svg` && (r.schema = `svg`);
    var l2 = e.properties;
    s = ((e2, t2) => {
      if (t2 == null || typeof t2 != `object`) return bn;
      var r2, s2, a3 = !!e2.settings.tightAttributes, n2 = bn, i2 = true;
      for (r2 in t2) s2 = t2[r2], s2 == null || (r2 = rn(e2, r2, s2), r2.length > 0 && (i2 || (i2 = a3 && n2.length > 0 ? n2.charAt(n2.length - 1) : bn, (!a3 || i2 != `"` && i2 != `'`) && (n2 = n2 + ` `)), n2 = n2 + r2, i2 = false));
      return n2;
    })(r, l2), g2 = i == `html` && o == `template` ? e.content : e, c2 = z(g2), p2 = x(c2), m2 = bn, b2 = 0;
    while (b2 < p2) m2 += _(c2[b2], b2, g2, r), b2++;
    r.schema = i, m2.length > 0 && (u = false), !(0 == s.length && A2 && $t(e, t, n)) ? (r = `<` + o, s.length > 0 && (r = r + ` ` + s), u && (i == `svg` || a2.closeSelfClosing) && (i = s.length > 0 ? s.charAt(s.length - 1) : bn, (a2.tightSelfClosing ? i == `/` || i.length > 0 && i != `"` && i != `'` : true) && (r = r + ` `), r = r + `/`), r = r + `>`) : r = bn, r += m2, u || !(A2 && Q(e, t, n)) && (r = r + `</` + o + `>`);
    return r;
  }
  O(`Cannot compile unknown node \`` + i + `\``);
  return bn;
};
var Pe = (e, t) => {
  if (!(t == null || typeof t != `object`)) for (var n in t) e[n] = t[n];
...
var Fe = (0, function() {
  var n = ce(arguments), e = Array.prototype.pop.call(n);
  typeof e == `function` || v(`Expected function as last argument, not ` + e);
  var r, t = { middlewareIndex: -1, values: n, fns: this.fns, callback: e };
  r = function(e2) {
    var s2 = t.fns, i2 = +t.middlewareIndex + 1;
    t.middlewareIndex = i2;
    var a2 = void 0;
    i2 |= 0, i2 < s2.length && (a2 = s2[i2]), i2 = void 0, s2 = [];
    var o = arguments.length;
    if (o > 0) {
      i2 = e2;
      var n2, m2, u, b2 = 1;
      while (b2 < o) s2.push(arguments[b2]), b2++;
    }
    if (i2) {
      t.callback(i2);
      return;
    }
    for (b2 = t.values, o = b2.length, n2 = -1; ++n2 < o; ) i2 = void 0, n2 < s2.length && (i2 = s2[n2]), i2 == null && ((e3, t2, n3) => {
      var r2 = e3.length;
      if (t2 >= r2) {
        while (r2 < t2) g.call(e3, void 0), r2++;
        g.call(e3, n3);
        return;
      }
      ae.call(e3, t2, 1, n3);
    ...
    t.values = s2;
    if (typeof a2 == `function`) n2 = r, u = { called: false }, n2 = /* @__PURE__ */ ((e3) => function() {
      if (!u.called) u.called = true, e3.apply(void 0, arguments);
    })(n2), i2 = function(e3) {
      let t2 = [A, e3];
      n2.apply(void 0, t2);
    }, (function() {
      var r2 = ce(arguments), t2 = a2.length;
      t2 = t2 > r2.length, t2 && g.call(r2, n2);
      var e3;
      try {
        e3 = a2.apply(this, r2);
      } catch (e4) {
        if (t2 && u.called) throw e4;
        var s3 = [];
        g.call(s3, e4), n2.apply(void 0, s3);
        return;
      }
      if (!t2) {
        var b3;
        e3 && e3.then && typeof e3.then == `function` ? e3.then(i2, n2) : (e3 == null ? false : typeof e3 != `object` && typeof e3 != `function` ? false : !!Error.prototype.isPrototypeOf(e3)) ? (b3 = [e3], n2.apply(void 0, b3)) : i2(e3);
      }
    }).apply(void 0, s2);
    else {
      m2 = [A], a2 = s2.length, n2 = 0;
      while (n2 < a2) m2.push(s2[n2]), n2++;
      t.callback.apply(void 0, m2);
    }
  }, e = [], e.push(A);
  var s = n.length, i = 0;
  while (i < s) e.push(n[i]), i++;
  r.apply(void 0, e);
});
var Me = (0, function(e) {
  return typeof e == `function` || v(`Expected \`middelware\` to be a function, not ` + e), g.call(this.fns, e), this;
});
var q = class {
  constructor(e) {
    this.data = {}, this.history = [], this.messages = [], this.cwd = bn;
    if (!e) return this;
    if (typeof e == `string` || le(e)) return this.value = e, this;
    if (typeof e == `object`) for (var t in e) this[t] = e[t];
  }
  message(e) {
    var t = new Error(e + "");
    t.fatal = false, t.reason = e + "", g.call(this.messages, t);
    return t;
  }
  toString(e) {
    e = this.value;
    return e === void 0 ? bn : `string` == typeof e ? e : e + "";
  }
  fail() {
    let e = this.message.apply(this, arguments);
    e.fatal = true;
    throw e;
  }
  info() {
...
var Ge = (0, function() {
  M(`use`, this.frozen);
  var t = this.attachers, n = this.namespace, e = void 0;
  arguments.length > 0 && (e = arguments[0]);
  if (e == null) return this;
  if (typeof e == `function`) return B(t, e, R(arguments)), this;
  if (typeof e == `object`) return Array.isArray(e) ? be(t, n, e) : ve(t, n, e), this;
  throw new TypeError(vn + e + `\``);
});
var Ye = (0, function(e) {
  this.freeze(), e = S(e);
  let t = G(this);
...
var Be = (0, function(e, t, n) {
  ge(e);
  var s = this.freeze;
  this.freeze(), !n && typeof t == `function` && (n = t, t = void 0);
  var i = this.transformers, r = function(r2, s2) {
    let a2 = S(t), b2 = function(t2, i2, a3) {
      var b3 = !i2 ? e : i2;
      if (t2) {
        s2(t2);
        return;
...
var Ve = (0, function(e, t) {
  let n = { complete: false, result: void 0 }, r = function(e2, t2, r2) {
    de(e2), n.result = t2, n.complete = true;
  };
  this.run(e, t, r), ye(`runSync`, `run`, n.complete), he(n.result);
  return n.result;
});
var We = (0, function(e, t) {
  this.freeze();
  let n = S(t);
  t = Y(this), F(`stringify`, t), ge(e);
  return t(e, n);
});
var Ke = (0, function(e, t) {
  var n = this;
  n.freeze(), P(`process`, G(n)), F(`process`, Y(n));
  var r = function(r2, i) {
    let s = S(e), a2 = n.parse(s), b2 = function(e2, s2, a3) {
      if (e2 || !s2 || !a3) {
        i(e2);
        return;
      }
      var b3 = n.stringify(s2, a3);
      (typeof b3 == `string` ? true : le(b3)) ? a3.value = b3 : a3.result = b3;
      if (r2) {
        r2(a3);
        return;
      }
...
var Xe = (0, function(e) {
  this.freeze(), P(`processSync`, G(this)), F(`processSync`, Y(this));
  let t = { complete: false, result: void 0 }, n = function(e2, n2) {
    t.complete = true, de(e2), t.result = n2;
  };
  this.process(e, n), ye(`processSync`, `process`, t.complete), he(t.result);
  return t.result;
});
var Ze = (0, function(e, t) {
  var r = this.namespace, i = arguments.length, n = void 0;
  i > 0 && (n = e);
  if (`string` == typeof n) {
    if (2 == i) return M(`data`, this.frozen), r[n] = t, this;
    if (C.call(r, n)) {
      var s = r[n];
      if (s) return s;
    }
  ...
  return n ? (M(`data`, this.frozen), this.namespace = n, this) : r;
});
var Je = (0, function() {
  if (this.frozen) return this;
  var t = this.attachers, r = this.transformers;
  while (true) {
    var e = +this.freezeIndex + 1;
    this.freezeIndex = e;
    if (e >= t.length) break;
    var n = t[e], i = n[0];
    e = R(n);
    if (!(e.length > 0 && e[0] === false)) e.length > 0 && true === e[0] && ae.call(e, 0, 1, void 0), e = i.apply(this, e), typeof e == `function` && r.use(e);
  }
  this.frozen = true;
...
var ie = {};
var se = false;
var E = { one: function(e, t) {
  return Ue(e, t);
}, element: function(e, t) {
  return ((e2, t2) => {
    var u = K(e2);
    e2.space = f(t2.namespaceURI) == `http://www.w3.org/2000/svg` ? `svg` : `html`;
    var o = {}, n = t2.attrs;
    if (Array.isArray(n)) {
      var i, a2, r, m2 = Object.prototype, c2 = n.length, s = 0;
      while (s < c2) i = n[s], a2 = f(i.prefix), r = f(i.name), a2.length > 0 && (r = a2 + `:` + r), C.call(m2, r) || (o[r] = i.value), s++;
    }
    r = K(e2);
    n = f(t2.tagName), r = ((e3, t3, n2, r2) => {
      var s2 = {}, i2 = n2 == null;
      if (!i2) for (i2 in n2) ((e4, t4, n3, r3) => {
        if (r3 != null) {
          var i3 = V(e4, n3);
          n3 = i3.property, `string` == typeof n3 || (n3 = bn);
          var s3 = Ee(i3);
          `string` == typeof r3 && (r3 = (e4 != `svg` ? false : n3 == `about` || n3 == `kernelMatrix` || n3 == `property` || n3 == `rel` || n3 == `requiredExtensions` || n3 == `requiredFeatures` || n3 == `requiredFonts` || n3 == `requiredFormats` || n3 == `rev` || n3 == `strokeDashArray` || n3 == `systemLanguage` || n3 == `typeOf`) ? Te(((e5) => {
            var n4, i4 = e5.length, t5 = bn, r4 = 0;
            while (r4 < i4) r4 > 0 && (t5 = t5 + ` `), n4 = e5[r4], t5 = `string` == typeof n4 ? t5 + n4 : t5 + n4 + "", r4++;
            return t5;
          })(Ne(r3))) : b(s3, `s`) ? Te(r3) : b(s3, `c`) ? Ne(r3) : Re(e4, n3, s3, r3));
          if (Array.isArray(r3)) {
            i3 = [];
            var o2 = r3.length, a3 = 0;
            while (a3 < o2) i3.push(Re(e4, n3, s3, r3[a3])), a3++;
          } else {
            i3 = r3;
          }
          if (n3 == `className` && Array.isArray(t4.className)) {
            e4 = t4.className;
            if (Array.isArray(i3)) {
              s3 = i3.length, r3 = 0;
              while (r3 < s3) g.call(e4, i3[r3]), r3++;
            } else g.call(e4, i3);
          } else {
            e4 = i3;
          }
      ...
      return { type: `element`, tagName: t3, properties: s2, children: r2 };
    })(r, n, o, Oe(e2, t2.childNodes)), U(e2, t2, r), f(r.tagName) == `template` && (s = E.one(e2, t2.content), n = t2.sourceCodeLocation, t2 = n == null, !t2 && e2.file && (t2 = j(n.startTag), i = j(n.endTag), n = t2 == null, !n && i != null && (n = t2.end, s.position = { start: n, end: i.start })), r.content = s), e2.space = u;
    return r;
  })(e, t);
} };
var L = void 0;
var oe = (0, function(e) {
  var n = {}, t = this === void 0 || this == null;
  t || (t = this.data, typeof t == `function` && J(n, this.data(`settings`))), J(n, e), t = n.emitParseErrors, e = this === void 0 || this == null, e || (this.parser = function(e2, r) {
    var i = {};
    J(i, n), i.onerror = t ? function(e3) {
      var t2 = r == null;
      if (!t2) (t2 = r.path) && (e3.name = t2 + `:` + e3.name, e3.file = t2), t2 = r.messages, Array.isArray(t2) && g.call(t2, e3);
    } : void 0;
    return ((e3, t2) => {
      if ((n2 = t2, t2 === void 0) || t2 == null) var n2 = {};
      var r2 = ((e4) => {
        if (`string` == typeof e4) return e4;
        if (e4 == null) return bn;
        var t3 = e4.toString;
        if (typeof t3 == `function`) {
          e4 = e4.toString();
          return `string` == typeof e4 ? e4 : e4 + "";
        }
        return typeof e4 == `object` && `string` == typeof (t3 = e4.value) ? t3 : e4 + "";
      })(e3), s = n2.onerror, i2 = { sourceCodeLocationInfo: true, scriptingEnabled: false };
      i2.onParseError = s && typeof s == `function` ? function(e4) {
        ((e5, t3, n3, r3) => {
          var b2 = e5.code;
          `string` == typeof b2 || (b2 = bn);
          var i3 = ((e6) => {
            var r4 = e6.length, n4 = bn, t4 = 0;
            while (t4 < r4) t4 + 1 < r4 && e6.charAt(t4) == `-` ? (n4 = n4 + e6.charAt(t4 + 1).toUpperCase(), t4 = t4 + 2 | 0) : (n4 = n4 + e6.charAt(t4), t4++);
            return n4;
          })(b2), a3 = ((e6, t4) => {
            t4 = e6[t4];
            return t4 == null ? 1 : typeof t4 == `number` ? t4 | 0 : t4 ? 1 : 0;
          })(n3, i3);
          if (0 != a3) {
            n3 = ((e6) => {
              L === void 0 && (L = getErrors());
              return L[e6];
            })(i3);
            if (n3 != null) {
              i3 = Z(bn, t3, e5);
              var s2 = n3.reason;
              `string` == typeof s2 && (i3 = Z(s2, t3, e5)), s2 = e5.startLine;
              var o = e5.startCol;
              s2 = { line: s2, column: o, offset: e5.startOffset }, o = e5.endLine;
              var u = e5.endCol;
              i3 = ((e6, t4, n4) => {
                var r4 = new Error(e6), i4 = t4 != null && `start` in t4 ? t4.start : t4, s3 = Ce(t4);
                0 == s3.length && (s3 = `1:1`), Object.defineProperty(r4, `stack`, { enumerable: false, configurable: true, writable: true, value: bn }), Object.defineProperty(r4, `message`, { enumerable: true, configurable: true, writable: true, value: e6 }), r4.name = s3, r4.reason = e6, r4.ruleId = n4, r4.source = `hast-util-from-html`, r4.place = t4, r4.file = bn, e6 = i4 == null, e6 || (r4.line = i4.line, r4.column = i4.column);
                return r4;
              })(i3, { start: s2, end: { line: o, column: u, offset: e5.endOffset } }, b2), i3.fatal = 2 == a3 ? true : 1 == a3 ? false : void 0, a3 = n3.description, `string` == typeof a3 && (i3.note = Z(a3, t3, e5)), i3.url = false === n3.url ? void 0 : `https://html.spec.whatwg.org/multipage/parsing.html#parse-error-` + b2, r3(i3);
            }
          }
        })(e4, r2, n2, s);
      } : JSON.parse(`null`), i2 = n2.fragment ? parseFragment(r2, i2) : parse(r2, i2), (`string` == typeof e3 || e3 == null || typeof e3 != `object`) && (e3 = { value: r2, toString: function() {
        return r2;
      } }), t2 = { file: e3, space: n2.space, verbose: n2.verbose }, t2 == null && (t2 = {});
      var a2 = f(t2.space) == `svg` ? `svg` : `html`;
      e3 = { file: t2.file, location: false, space: a2, verbose: !!t2.verbose }, e3 = Ue(e3, i2);
      return e3;
    })(e2, i);
  });
});
var ue = (0, function(e) {
  var t = ((e2, t2) => {
    var n = {}, r = e2 == null;
    r || (r = e2.data, typeof r == `function` && Pe(n, e2.data(`settings`))), Pe(n, t2);
    return n;
  })(this, e);
  e = this === void 0 || this == null, e || (this.compiler = function(e2) {
    return ((e3, t2) => {
      t2 == null && (t2 = {});
      var i, s, n = t2.quote, r = n == null;
      !r ? `string` == typeof n || (n = h(n)) : n = `"`, n != `"` && n != `'` && O(`Invalid quote \`` + n + `\`, expected \`'\` or \`"\``), i = n == `'` ? `"` : `'`, s = h(t2.space) == `svg` ? `svg` : `html`, r = { settings: ((e4) => {
        e4 == null && (e4 = {});
        return { omitOptionalTags: c(e4.omitOptionalTags), allowParseErrors: c(e4.allowParseErrors), allowDangerousCharacters: c(e4.allowDangerousCharacters), quoteSmart: c(e4.quoteSmart), preferUnquoted: c(e4.preferUnquoted), tightAttributes: c(e4.tightAttributes), upperDoctype: c(e4.upperDoctype), tightDoctype: c(e4.tightDoctype), bogusComments: c(e4.bogusComments), tightCommaSeparatedLists: c(e4.tightCommaSeparatedLists), tightSelfClosing: c(e4.tightSelfClosing), collapseEmptyAttributes: c(e4.collapseEmptyAttributes), allowDangerousHtml: c(e4.allowDangerousHtml), characterReferences: e4.characterReferences, closeSelfClosing: c(e4.closeSelfClosing), closeEmptyElements: c(e4.closeEmptyElements), voids: e4.voids };
      })(t2), schema: s, quote: n, alternative: i }, Array.isArray(e3) && (e3 = { type: `root`, children: e3 });
      return _(e3, -1, void 0, r);
    })(e2, t);
  });
});
wn = Qe();
